...
class OptimizedAudioVisualizer:
    ...
    def _prepare_template_variables(self, target_blend_path: str) -> Dict[str, str]:
        ...
        return {
            ...
            'use_adaptive_sampling': str(self.quality_config.use_adaptive_sampling),
            'adaptive_threshold': str(self.quality_config.adaptive_threshold),
            'adaptive_min_samples': str(self.quality_config.adaptive_min_samples),
            'use_fast_gi': str(self.quality_config.use_fast_gi),
            'caustics_reflective': str(self.quality_config.caustics_reflective),
            'caustics_refractive': str(self.quality_config.caustics_refractive),
