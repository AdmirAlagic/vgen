...
struct MetalVisualizationView: NSViewRepresentable {
    ...
    class Coordinator: NSObject {
        ...
        var metalDelegate: MetalViewDelegate?
...
extension MetalRenderer: MTKViewDelegate {
    ...
    func draw(in view: MTKView) {
        ...
        let _: VisualizationStyle = .circularWave // Default fallback
...
class MetalView: NSView {
    ...
    private var metalDelegate: MetalViewDelegate!
    ...
    private func setupMetal() {
        ...
        metalDelegate = MetalViewDelegate(renderer: renderer, 
                                        audioEngine: audioEngine, 
                                        style: visualizationStyle)
        metalKitView.delegate = metalDelegate
...
// Note: Using the main MetalVisualizationView struct defined above
