...
struct ContentView: View {
    ...
    init() {
        _renderer = StateObject(wrappedValue: {
            do {
    ...
    var body: some View {
        ...
        .fileDialogMessage("Select an audio file to visualize")
        ...
        .fileDialogMessage("Choose export location")
        .fileExporter(
            isPresented: $showingExportDialog,
            document: VideoDocument(),
            contentType: .mpeg4Movie,
            defaultFilename: "WavePro_Export"
        ) { result in
            switch result {
