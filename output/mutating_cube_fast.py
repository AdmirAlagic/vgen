...
# Set shape key value and insert keyframe for frame 56
scene.frame_set(56)
shape_key.value = -0.7651394673673806
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 128
scene.frame_set(128)
shape_key.value = -0.5442192785671967
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 224
scene.frame_set(224)
shape_key.value = 0.008793538296034575
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 24
scene.frame_set(24)
shape_key.value = 0.086781230995431
shape_key.keyframe_insert(data_path="value")
...
# Save blend file
bpy.ops.wm.save_as_mainfile(filepath="output/mutating_cube_fast.blend")
print("💾 Blend file saved: output/mutating_cube_fast.blend")
