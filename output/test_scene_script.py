...
def create_procedural_material(name, material_type='metallic_abstract'):
    ...
    if material_type == 'metallic_abstract':
        ...
        principled.inputs[9].default_value = (0.05, 0.05, 0.05)  # Roughness
...
principled.inputs[9].default_value = (0.7, 0.7, 0.7)
...
# Simple displacement without texture
...
import os
output_dir = os.path.dirname("/Users/admir/ai/AudioBlenderVideo/output/test_scene.blend")
...
# Save blend file
blend_path = "/Users/admir/ai/AudioBlenderVideo/output/test_scene.blend"
