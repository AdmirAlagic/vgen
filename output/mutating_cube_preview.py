...
# Set shape key value and insert keyframe for frame 180
scene.frame_set(180)
shape_key.value = -0.4289973903206571
shape_key.keyframe_insert(data_path="value")
...
# Save blend file
bpy.ops.wm.save_as_mainfile(filepath="output/mutating_cube_preview.blend")
print("💾 Blend file saved: output/mutating_cube_preview.blend")
