...
# Set shape key value and insert keyframe for frame 8
scene.frame_set(8)
shape_key.value = -0.31468298235547165
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 84
scene.frame_set(84)
shape_key.value = -0.8898736092568114
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 94
scene.frame_set(94)
shape_key.value = 0.001184491573950508
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 200
scene.frame_set(200)
shape_key.value = 0.25529796057395604
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 200
scene.frame_set(200)
shape_key.value = -0.2853527777261774
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 216
scene.frame_set(216)
shape_key.value = -0.14719182617892163
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 154
scene.frame_set(154)
shape_key.value = -0.7142828029383242
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 226
scene.frame_set(226)
shape_key.value = -0.09481816493725048
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 204
scene.frame_set(204)
shape_key.value = 0.7260723809507639
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 6
scene.frame_set(6)
shape_key.value = -0.0913347011298623
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 164
scene.frame_set(164)
shape_key.value = -0.4828394698193305
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 188
scene.frame_set(188)
shape_key.value = -0.1819043904923181
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 204
scene.frame_set(204)
shape_key.value = -0.14150929230177312
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 40
scene.frame_set(40)
shape_key.value = -0.29617170800335957
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 48
scene.frame_set(48)
shape_key.value = -0.15862139237129017
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 158
scene.frame_set(158)
shape_key.value = -0.28147525356581277
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 10
scene.frame_set(10)
shape_key.value = -0.05433443725147985
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 30
scene.frame_set(30)
shape_key.value = -0.2909134599858426
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 184
scene.frame_set(184)
shape_key.value = -0.17861638372090716
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 234
scene.frame_set(234)
shape_key.value = 0.08694237860693022
shape_key.keyframe_insert(data_path="value")
