...
import os
output_dir = os.path.dirname(r"/Users/admir/ai/AudioBlenderVideo/output/test_optimizations/test_balanced_scene.blend")
if output_dir:
    os.makedirs(output_dir, exist_ok=True)
    # FIX: Set proper video output path with .mp4 extension
    video_name = os.path.splitext(os.path.basename(r"/Users/admir/ai/AudioBlenderVideo/output/test_optimizations/test_balanced_scene.blend"))[0]
...
blend_path = r"/Users/admir/ai/AudioBlenderVideo/output/test_optimizations/test_balanced_scene.blend"
