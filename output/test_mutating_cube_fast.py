...
scene.frame_set(88)
shape_key.value = -0.25796002617632596
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 120
scene.frame_set(120)
shape_key.value = -0.7807333904249305
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 144
scene.frame_set(144)
shape_key.value = -0.6847894890682821
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 128
scene.frame_set(128)
shape_key.value = -0.13204755576877747
shape_key.keyframe_insert(data_path="value")
...
# Set shape key value and insert keyframe for frame 192
scene.frame_set(192)
shape_key.value = -0.0628478667830254
shape_key.keyframe_insert(data_path="value")
...
# Save blend file
bpy.ops.wm.save_as_mainfile(filepath="output/test_mutating_cube_fast.blend")
print("💾 Blend file saved: output/test_mutating_cube_fast.blend")
