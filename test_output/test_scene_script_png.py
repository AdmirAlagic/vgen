...
scene.render.filepath = os.path.join("test_output/temp", "frame_####")
...
# Save blend file for PNG rendering
import os
output_dir = os.path.dirname("test_output/temp")
os.makedirs(output_dir, exist_ok=True)

# Save the blend file for rendering
bpy.ops.wm.save_as_mainfile(filepath=os.path.join("test_output/temp", "scene.blend"))
print(f"Scene saved for PNG rendering")
print("Ready to render PNG sequence!")
